<link rel="stylesheet" href="/css/owl.carousel.min.css">
    ...
    <div class="owl-carousel owl-theme">
      ...
      <div class="item">
        <div class="card" style="width: 15rem;height:60vh;">
          @if(!empty($feria->imagen[0]["nombre"]))
            <img src="/storage/{{$feria->imagen[0]["nombre"]}}" style="height: 30vh" alt="">
          @else
             <img src="/images/logo_feriate_deffault_ii.png" style="width:30vh; height: 30vh" alt="">
          @endif
          <div class="card-body">
